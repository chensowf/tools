...
:again
echo Stating Server openvpn...
openvpn --cd %work_dir%\etc\openvpn --config server.ovpn --log %work_dir%\var\server.log --status %work_dir%\var\server.status
echo Server openvpn Exited...
goto again
